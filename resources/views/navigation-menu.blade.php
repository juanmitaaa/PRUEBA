<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('incidences.index') }}" :active="request()->routeIs('incidences.index')">
                <x-icon name="inbox" class="h-4 w-4" /> {{ __('Incidences') }}
            </x-jet-nav-link>  
            @can("read", "")  
            ...
            <x-jet-responsive-nav-link href="{{ route('customers.index') }}" :active="request()->routeIs('customers.index')">
                <x-icon name="clipboard" class="h-4 w-4" /> {{ __('Customers') }}
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{ route('manufacturers.index') }}" :active="request()->routeIs('manufacturer.index')">
                <x-icon name="truck" class="h-4 w-4" /> {{ __('Manufacturers') }}
            </x-jet-responsive-nav-link>
            ...
            <x-jet-responsive-nav-link href="{{ route('tickets.index') }}" :active="request()->routeIs('tickets.index')">
                <x-icon name="document" class="h-4 w-4" /> {{ __('Tickets') }}
            </x-jet-responsive-nav-link>
